...
USAGE:
    python build/build_pgo_unified.py          # Auto-detect compiler
    python build/build_pgo_unified.py --clang  # Force Clang
    python build/build_pgo_unified.py --msvc   # Force MSVC
...
def build_msvc_pgo():
    ...
    msvc_script = PROJECT_ROOT / "build" / "build_pgo.py"
