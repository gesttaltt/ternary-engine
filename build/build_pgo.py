...
Usage (run from project root):
    python build/build_pgo.py instrument    # Phase 1: Build with instrumentation
    python build/build_pgo.py profile       # Phase 2: Run profiling workload
    python build/build_pgo.py optimize      # Phase 3: Build optimized version
    python build/build_pgo.py clean         # Clean PGO artifacts
    python build/build_pgo.py full          # Run all phases automatically
