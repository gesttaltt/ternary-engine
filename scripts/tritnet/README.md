...
**Usage:**
```bash
python scripts/tritnet/generate_truth_tables.py [--output-dir DIR]
```

**Outputs:**
- `datasets/tritnet/tadd_truth_table.json` - Addition (59,049 samples)
- `datasets/tritnet/tmul_truth_table.json` - Multiplication (59,049 samples)
- `datasets/tritnet/tmin_truth_table.json` - Minimum (59,049 samples)
- `datasets/tritnet/tmax_truth_table.json` - Maximum (59,049 samples)
- `datasets/tritnet/tnot_truth_table.json` - Negation (243 samples)
- `datasets/tritnet/generation_summary.json` - Statistics
...
python scripts/tritnet/train_tritnet.py \
  --operation tadd \
  --hidden-size 16 \
  --learning-rate 0.001 \
  --max-epochs 2000
...
- **Dataset Documentation:** `datasets/tritnet/README.md`
