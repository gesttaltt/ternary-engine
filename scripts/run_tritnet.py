...
Example workflows:
    ...
    python scripts/run_tritnet.py --phase datasets --train tnot
...
def check_prerequisites():
    ...
    try:
        ...
        errors.append("python scripts/build/build_dense243.py")
...
def phase_datasets():
    ...
    script = PROJECT_ROOT / "scripts" / "tritnet" / "generate_truth_tables.py"
    ...
    datasets_dir = PROJECT_ROOT / "datasets" / "tritnet"
    ...
    if summary_file.exists():
        ...
        print("\nSkipping regeneration. To regenerate, delete datasets/tritnet/ first.")
        return 0
...
def phase_training(operation: str = None, train_all: bool = False):
    ...
    script = PROJECT_ROOT / "scripts" / "tritnet" / "train_tritnet.py"
