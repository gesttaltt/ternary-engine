...
**Doc-Type:** Project-Level Configuration · Version 1.61 · Updated 2026-08-29 · Author Ternary Engine Team
...
- Throughput at equivalent bit-width: > INT2 ✅ Proven — Dense243 8.0× faster
  ...
  Phase 3 fix.
- Inference latency: < 2× FP16 ⚠️ **Never measured — the one remaining
  criterion that is tractable in this environment.** See
  docs/planning/ROADMAP.md → "Where To Continue".
...
**Current status:** 2/5 criteria validated (unchanged in count; criterion 2's
⚠️ was stale bookkeeping, not a new result)
...
**Version:** 1.61.0 · **Updated:** 2026-08-29 · **Project:** Ternary Engine · **Repository:** https://github.com/gesttaltt/ternary-engine
