...
**Doc-Type:** Project-Level Configuration · Version 1.62 · Updated 2026-08-29 · Author Ternary Engine Team
...
- Power consumption: 2-4× better ⚠️ **Blocked, not merely untested.** Checked
  2026-08-29: RAPL powercap domains exist here but `energy_uj` is not
  readable without root (post-side-channel-disclosure mitigation) and
  `perf_event_paranoid` is 4. GPU power is readable but measures the wrong
  device — the ternary kernels are CPU AVX2. Needs root or other hardware.
...
**Version:** 1.62.0 · **Updated:** 2026-08-29 · **Project:** Ternary Engine · **Repository:** https://github.com/gesttaltt/ternary-engine
